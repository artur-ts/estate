...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="{{ route('admin-dashboard.') }}"> {{ __('Start Bootstrap') }}</a>
    <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="menuAccordion">
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="{{ __('Dashboard') }}">
                <a class="nav-link" href="{{ route('admin-dashboard.') }}">
                    <i class="fa fa-fw fa-dashboard"></i>
                    <span class="nav-link-text">{{ __('Dashboard') }}</span>
                </a>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="{{ __('Posts') }}">
                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapsePosts" data-parent="#menuAccordion">
                    <i class="fa fa-fw fa-wrench"></i>
                    <span class="nav-link-text">{{ __('Posts') }}</span>
                </a>
                <ul class="sidenav-second-level collapse" id="collapsePosts">
                    <li>
                        <a href="{{ route('admin-dashboard.posts.index') }}">{{ __('List') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('admin-dashboard.posts.create') }}">{{ __('Create') }}</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="{{ __('Categories') }}">
                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseCategories" data-parent="#menuAccordion">
                    <i class="fa fa-fw fa-wrench"></i>
                    <span class="nav-link-text">{{ __('Categories') }}</span>
                </a>
                <ul class="sidenav-second-level collapse" id="collapseCategories">
                    <li>
                        <a href="{{ route('admin-dashboard.categories.index') }}">{{ __('List') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('admin-dashboard.categories.create') }}">{{ __('Create') }}</a>
                    </li>
                </ul>
            </li>
        </ul>
